...
////// Lighting:
////// Emissive:
                float2 node_60 = ((i.uv0.rg+1.15*float2(0,1))*float2(1,0.3));
                float4 node_329 = _Time + _TimeEditor;
                float2 node_328 = i.uv0;
                float2 node_116 = (node_328.rg+node_329.g*float2(0.1,-0.2));
                float2 node_118 = (node_328.rg+node_329.g*float2(-0.15,0.08));
                float node_201 = 2.0;
                float4 node_6 = i.vertexColor;
                float3 emissive = ((float3(1,0.7923935,0.3455882)*((1.5*tex2D(_node_2,TRANSFORM_TEX(node_60, _node_2)).rgb)*(tex2D(_node_106,TRANSFORM_TEX(node_116, _node_106)).rgb*tex2D(_node_107,TRANSFORM_TEX(node_118, _node_107)).r*node_201)*node_201))*tex2D(_node_4,TRANSFORM_TEX(node_328.rg, _node_4)).rgb*node_6.rgb);
